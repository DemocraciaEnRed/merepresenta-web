    ...
    <div class="hero-body p-2">
        ...
        <section class="container p-4 has-text-centered">
            <div >
                ...
                <VerdaderoFalso  background='games/verdaderofalso.png' url={null} />

                <div class="columns">
                    <div class="column is-half mx-auto my-6 ">
                        <h3 class="subtitle light has-text-white is-4">
                            ¿Te gustan más los juegos de mesa?
                            <span class="has-text-weight-medium">Descargate nuestro juego de la oca para imprimir y jugar en casa</span>
                        </h3>
                    </div>
