...
<div
	...
	class="proposal-header has-background-white is-flex is-flex-direction-row is-align-items-center"
>
	...
	>
		<div
			...
			style="background-color: {proposal.ejes_id.color}; height: 100%;"
		>
		...
		<div class="column is-4">
			<div class="my-4 has-text-centered-touch has-text-left-desktop">
				...
				{#if partido.url_fuente}
					...
					<p>
						Podés leer las propuestas completas en la <a
							href={partido.url_fuente}
							target="_blank"
							class="is-uppercase has-text-black has-text-weight-semibold"><u>fuente oficial</u></a
						>
					</p>
				{/if}
