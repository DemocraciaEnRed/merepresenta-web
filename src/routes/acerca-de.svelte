...
<main>
    <div class="hero is-black is-halfheight tetris-background">
		<div class="hero-body">
			<div class="container">
				<img src="/logo-merepresenta.svg" width="400" class="image p-4 mb-5 is-hidden-desktop" alt="Logo de Me Representa">
