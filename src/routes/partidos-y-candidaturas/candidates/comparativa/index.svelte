		...
		<div class="container">
			<div class="has-text-centered has-text-black">
				...
				<h3 class="is-size-4 has-text-weight-light">
                    ...
                    Aquí podrás elegir y comprar sus perfiles
				</h3>
			</div>
          ...
          <tr>
            ...
            <td>
              <div class="select is-medium mx-3 is-white">
                  <select id="candidate1" class="has-background-grey-dark has-text-white has-text-weight-light" bind:value={candidate1} >
            ...
            <td>
              <div class="select is-medium mx-3 is-white">
                  <select id="candidate2" class="has-background-grey-dark has-text-white has-text-weight-light" bind:value={candidate2} >
                          <option value={null} disabled selected>elegi una candidatura</option>
                      {#each candidates as candidate}
                          <option value={candidate}>{candidate.name}</option>
                      {/each}
              ...
              <div>
                ...
                <div class=" has-text-black mb-3">    
                  <div class="is-flex is-flex-direction-column is-justify-content-space-between element-group">
                    ...
                    <p class="has-text-weight-light">Candidat{candidate1.genre === 'm' ? 'o': 'a' } a {cargosSlugs[candidate1.cargo][candidate1.genre]}</p>
                  </div>
                </div>
                <div class=" has-text-black mb-3">    
                  <div class="is-flex is-flex-direction-column is-justify-content-space-between element-group">
              ...
              <div>
                ...
                <div class=" has-text-black mb-3">    
                  <div class="is-flex is-flex-direction-column is-justify-content-space-between element-group">
                    ...
                    <p class="has-text-weight-light">Candidat{candidate2.genre === 'm' ? 'o': 'a' } a {cargosSlugs[candidate2.cargo][candidate2.genre]}</p>
                  </div>
                </div>
                <div class=" has-text-black mb-3">    
                  <div class="is-flex is-flex-direction-column is-justify-content-space-between element-group">
            ...
            <td>
              {#if candidate1}
                <div class=" has-text-black">    
                  <div class="is-flex is-flex-direction-column is-justify-content-center element-group">
                    <p class=" has-text-weight-bold is-size-5 is-uppercase">Redes sociales:</p>
                    <div class="is-flex is-justify-content-center">
                      {#if candidate1.twitter_profile}
                      <a href="{candidate1.twitter_profile}" target="_blank" class="has-text-black"><Icon icon="fa-twitter-square" brand size="large"/></a>
                      {/if}
                      {#if candidate1.twitter_user && candidate1.twitter_user !== candidate1.twitter_profile}
                      <a href="{candidate1.twitter_user}" target="_blank" class="has-text-black"><Icon icon="fa-twitter-square" brand size="large"/></a>
                      {/if}
                      {#if candidate1.facebook_page}
                      <a href="{candidate1.facebook_page}" target="_blank" class="has-text-black"><Icon icon="fa-facebook-square" brand size="large"/></a>
                      {/if}
                      {#if candidate1.facebook_profile}
                      <a href="{candidate1.facebook_profile}" target="_blank" class="has-text-black"><Icon icon="fa-facebook-square" brand size="large"/></a>
                      {/if}
                      {#if candidate1.instagram_page}
                      <a href="{candidate1.instagram_page}" target="_blank" class="has-text-black"><Icon icon="fa-instagram-square" brand size="large"/></a>
                      {/if}
                    </div>
                  </div>
                </div>
                ...
                <div class=" has-text-black">    
                  <div class="is-flex is-flex-direction-column is-justify-content-center element-group">
                    ...
                    <div class="is-flex is-justify-content-center">
                      ...
                      <a href="{candidate2.twitter_profile}" target="_blank" class="has-text-black"><Icon icon="fa-twitter-square" brand size="large"/></a>
                      {/if}
                      {#if candidate2.twitter_user && candidate2.twitter_user !== candidate2.twitter_profile}
                      <a href="{candidate2.twitter_user}" target="_blank" class="has-text-black"><Icon icon="fa-twitter-square" brand size="large"/></a>
                      {/if}
                      {#if candidate2.facebook_page}
                      <a href="{candidate2.facebook_page}" target="_blank" class="has-text-black"><Icon icon="fa-facebook-square" brand size="large"/></a>
                      {/if}
                      {#if candidate2.facebook_profile}
                      <a href="{candidate2.facebook_profile}" target="_blank" class="has-text-black"><Icon icon="fa-facebook-square" brand size="large"/></a>
                      {/if}
                      {#if candidate2.instagram_page}
                      <a href="{candidate2.instagram_page}" target="_blank" class="has-text-black"><Icon icon="fa-instagram-square" brand size="large"/></a>
                      {/if}
                    </div>
                  </div>
                </div>
