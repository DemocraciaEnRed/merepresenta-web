...
<main class="pb-6 has-background-white white-background-desktop">
	<div class="section tetris-background">
		<div class="container">
			<div class="has-text-centered has-text-black">
				...
				<h3 class="is-size-4 has-text-weight-light">
					¿Querés analizar las similitudes y diferencias entre las candidaturas? Aquí podrás elegir
					y comprar sus perfiles
				</h3>
			</div>
		</div>
									...
									<div class=" has-text-black mb-3">
										...
										>
											...
											<p class="has-text-weight-light">
												Candidat{candidate1.genre === 'm' ? 'o' : 'a'} a {cargosSlugs[
													candidate1.cargo
												][candidate1.genre]}
											</p>
										</div>
								...
								<div>
									...
									<div class=" has-text-black mb-3">
										...
										>
											...
											<p class="has-text-weight-light">
												Candidat{candidate2.genre === 'm' ? 'o' : 'a'} a {cargosSlugs[
													candidate2.cargo
												][candidate2.genre]}
											</p>
										</div>
										...
										<div class="is-flex is-justify-content-center">
											{#if candidate1.twitter_profile}
												<a href={candidate1.twitter_profile} target="_blank" class="has-text-black"
													><Icon icon="fa-twitter-square" brand size="large" /></a
												>
											{/if}
											...
											{#if candidate1.facebook_page}
												<a href={candidate1.facebook_page} target="_blank" class="has-text-black"
													><Icon icon="fa-facebook-square" brand size="large" /></a
												>
											{/if}
											...
											{#if candidate1.instagram_page}
												<a href={candidate1.instagram_page} target="_blank" class="has-text-black"
													><Icon icon="fa-instagram-square" brand size="large" /></a
												>
											{/if}
										</div>
									</div>
		...
		<table class="table is-fullwidth has-text-centered is-hidden-tablet">
			<thead>
				<tr>
					<th />
				</tr>
